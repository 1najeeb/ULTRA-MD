...
const defaultOwner = '923331285496';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '923331285496';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'Xehri🥋';
global.pairingNumber = process.env.BOT_NUMBER || '923331285496';  // put your number here
